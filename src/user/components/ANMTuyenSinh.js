...
import anm from '../access/img/ANM_7.jpg'
import anm1 from '../access/img/AN-NINH-MANG.jpg'
import pt1 from '../access/img/poster_1.png'

function ANMTuyenSinh() {
  return (
    <>
  ...
  <div className="container" id="about">
    <div className="row" style={{ marginTop: 50 }}>
      ...
      <div className="col-md-7 py-3 py-md-0">
        ...
        <li className='fz-18 mt-12'>Xét tuyển học bạ THPT</li>
        <li className='fz-18 mt-12'>Xét điểm thi THPT Quốc gia</li>
        <div className="btn mt-12">
        <a className='btn btn-dangky text-white' href='#dangkys1'>Đăng Ký Ngay</a>
        </div>
      </div>
    </div>
  </div>
