...
function ChuongTrinhDT() {
  return (
    ...
    <div className="row">
        ...
        <NavLink to='/tuyenSinhiSpace/an-ninh-mang' className="card">
            <img src={hinh1} alt="" />
        </NavLink>
        </div>
        <div className="col-md-4 py-3 py-md-0">
        <NavLink to='/tuyenSinhiSpace/thiet-ke-do-hoa' className="card">
            <img src={hinh2} alt="" />
        </NavLink>
        </div>
        <div className="col-md-4 py-3 py-md-0">
        <NavLink to='/tuyenSinhiSpace/phat-trien-phan-mem' className="card">
            <img src={hinh3} alt="" />
        </NavLink>
        </div>
    </div>
